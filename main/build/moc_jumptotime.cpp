...
namespace {
struct qt_meta_stringdata_JumpTime_t {
    uint offsetsAndSizes[2];
    char stringdata0[9];
};
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_JumpTime_t::offsetsAndSizes) + ofs), len 
Q_CONSTINIT static const qt_meta_stringdata_JumpTime_t qt_meta_stringdata_JumpTime = {
    {
...
Q_CONSTINIT static const uint qt_meta_data_JumpTime[] = {
...
Q_CONSTINIT const QMetaObject JumpTime::staticMetaObject = { {
    ...
    qt_meta_stringdata_JumpTime.offsetsAndSizes,
    qt_meta_data_JumpTime,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_JumpTime_t,
        // Q_OBJECT / Q_GADGET
...
void *JumpTime::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_JumpTime.stringdata0))
